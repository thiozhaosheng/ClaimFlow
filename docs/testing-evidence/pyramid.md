...
| --- | ---: | ---: | ---: | ---: | --- |
| Unit (Jest) | 78 | 78.0% | 45% | +33.0 pp | reports/jest-backend.json, reports/jest-frontend.json |
| Integration (Supertest) | 8 | 8.0% | 30% | -22.0 pp | reports/jest-backend.json |
| End-to-end (Playwright) | 2 | 2.0% | 15% | -13.0 pp | reports/playwright.json |
| Performance (k6) | 12 | 12.0% | 10% | +2.0 pp | reports/perf-summary.json |
| **Total** | **100** | **100.0%** | **100%** | | |
