...
export const DATABASE_URL = process.env.DATABASE_URL || 'postgresql://claimflowadmin:Admin%408088@claimflow-postgres-dev.postgres.database.azure.com:5432/claimflow?sslmode=require';
